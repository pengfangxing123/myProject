...
<script type="text/javascript">
	...
	// 保存
	function addSku(id){
		var marketPrice = $("#m"+id).val();
		var price = $("#p"+id).val();
		var stock = $("#i"+id).val();
		var upperLimit = $("#l"+id).val();
		var deliveFee = $("#f"+id).val();
		var url = "/sku/save.do";
		var params = {"marketPrice":marketPrice,"price":price,"stock":stock,"upperLimit":upperLimit,"deliveFee":deliveFee,"id":id};
