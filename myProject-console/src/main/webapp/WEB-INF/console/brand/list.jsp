	...
	<tbody class="pn-ltbody">
		<c:forEach items="${brands.list }" var="brand">
			<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
				...
				<td align="center">
				<a class="pn-opt" href="${pageContext.request.contextPath}/brand/edit.do?id=${brand.id }">修改</a> | <a class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;}" href="#">删除</a>
				</td>
			</tr>
		</c:forEach>
	</tbody>
...
<div class="page pb15">
	<span class="r inb_a page_b">
		<c:forEach items="${brands.pageView }" var="page">
			${page }
		</c:forEach>	
	</span>
</div>
